            ...
            <div className="text-center w-full font-bold text-3xl text-gray-600 p-4">
              ...
              <div className="flex flex-col gap-4 px-0 py-4">
                ...
                <div className="w-full flex flex-col gap-2">
                  <a href="http://localhost:3001/user/auth/google" className="bg-red-500 text-white w-full p-2 flex flex-row justify-center gap-2 items-center hover:bg-red-600 duration-100 ease-in-out">
